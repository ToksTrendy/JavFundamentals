...
public class DateCalculator {
    ...
    public static void main(String[] args) {
        ...
        int specificOperation, operation, dateOptionInput;
        ...
        String result;
        if (operation == 1) {
            result = performAddition(userDate, specificOperation, formatter, dateTimeFormatter, numberToCalculate);
        }else {
            result = performSubtraction(userDate, specificOperation, formatter, dateTimeFormatter, numberToCalculate);
        }
